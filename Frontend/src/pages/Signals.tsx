...
// // import { Radio, TrendingUp, TrendingDown, Search, Clock, Target, ShieldAlert, Zap } from "lucide-react";
...
// //     const matchesFilter = filter === "all" || (filter === "active" && s.accuracy_status === "Pending") || (filter === "completed" && s.accuracy_status !== "Pending");
...
// //           <div className="p-4 bg-primary/10 rounded-2xl border border-primary/20 shadow-[0_0_20px_rgba(var(--primary),0.1)]">
// //             <Radio className="w-8 h-8 text-primary animate-pulse" />
// //           </div>
// //           <div>
// //             <h1 className="text-4xl font-black tracking-tighter italic text-white">AI SIGNALS</h1>
// //             <p className="text-xs font-bold text-muted-foreground tracking-[0.3em] uppercase">Neural Prediction Engine</p>
// //           </div>
// //         </div>
...
// //           <input 
// //             type="text" 
// //             placeholder="Search Assets or Patterns..."
// //             value={searchQuery}
// //             onChange={(e) => setSearchQuery(e.target.value)}
// //             className="w-full pl-12 pr-4 py-3 bg-secondary/30 border border-white/5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all text-sm"
// //           />
// //         </div>
// //       </div>
...
// //               filter === f ? "bg-primary text-white shadow-xl shadow-primary/30" : "text-muted-foreground hover:text-white"
// //             }`}
// //           >
// //             {f}
// //           </button>
...
// //               className="glass-card group relative p-8 cursor-pointer border border-white/5 hover:border-primary/50 transition-all duration-500 rounded-[2rem] overflow-hidden"
// //             >
...
// //                   </div>
// //                   <div>
// //                     <h3 className="text-xl font-black text-white">{signal.module}</h3>
// //                     <div className="flex items-center gap-2 text-[10px] font-bold text-muted-foreground uppercase">
// //                       <Clock size={12} /> {getTimeAgo(signal.created_at)}
// //                     </div>
// //                   </div>
// //                 </div>
// //                 <div className={`px-4 py-1.5 rounded-full text-[10px] font-black border uppercase tracking-widest ${
// //                   signal.accuracy_status === "Pending" ? "bg-blue-500/10 text-blue-400 border-blue-500/30" : "bg-neon-green/10 text-neon-green border-neon-green/30"
// //                 }`}>
// //                   {signal.accuracy_status === "Pending" ? "Active" : "Profit Hit"}
// //                 </div>
// //               </div>

// //               <div className="space-y-2 mb-8">
// //                 <div className="flex items-baseline gap-3">
// //                   <span className={`text-4xl font-black italic tracking-tighter ${signal.signal === "BUY" ? "text-neon-green" : "text-neon-red"}`}>
// //                     {signal.signal}
// //                   </span>
// //                   <span className="text-muted-foreground font-mono text-lg">@ {formatPrice(signal.trade_entry)}</span>
// //                 </div>
...
// //                   <span className="text-[9px] font-black uppercase text-muted-foreground block mb-1">Take Profit</span>
// //                   <p className="text-base font-mono font-bold text-neon-green">{formatPrice(signal.trade_tp)}</p>
// //                 </div>
// //                 <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
// //                   <span className="text-[9px] font-black uppercase text-muted-foreground block mb-1">Stop Loss</span>
...
// //                     className={`h-full rounded-full ${signal.confidence_score > 85 ? 'bg-neon-green shadow-[0_0_10px_#00ff88]' : 'bg-primary shadow-[0_0_10px_#0077ff]'}`}
// //                   />
// //                 </div>
// //               </div>
// //             </motion.div>
...
// import { useState } from "react";
// import { motion, AnimatePresence } from "framer-motion";
// import { Radio, TrendingUp, TrendingDown, Search, Clock, Target, ShieldAlert } from "lucide-react";
// import { SignalModal } from "@/components/dashboard/SignalModal";
...
//     switch (status) {
//       case "Won":
//         return { label: "Won", className: "bg-neon-green/10 text-neon-green border-neon-green/30" };
//       case "Loss":
//         return { label: "Lost", className: "bg-neon-red/10 text-neon-red border-neon-red/30" };
//       default:
//         return { label: "Active", className: "bg-blue-500/10 text-blue-400 border-blue-500/30" };
//     }
//   };
...
//           </div>
//           <div>
//             <h1 className="text-4xl font-black tracking-tighter italic text-white uppercase">AI Signals</h1>
//             <p className="text-xs font-bold text-muted-foreground tracking-[0.3em] uppercase">Neural Prediction Feed</p>
//           </div>
//         </div>
...
//             value={searchQuery}
//             onChange={(e) => setSearchQuery(e.target.value)}
//             className="w-full pl-12 pr-4 py-3 bg-secondary/30 border border-white/5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all text-sm text-white"
//           />
//         </div>
//       </div>
...
//                 whileHover={{ y: -8 }}
//                 onClick={() => setSelectedSignal(signal)}
//                 className="glass-card group relative p-8 cursor-pointer border border-white/5 hover:border-primary/50 transition-all duration-500 rounded-[2rem] overflow-hidden bg-[#0d0d0d]"
//               >
//                 <div className={`absolute -right-16 -top-16 w-32 h-32 blur-[80px] opacity-20 ${signal.signal === "BUY" ? "bg-neon-green" : "bg-neon-red"}`} />
...
//                     </div>
//                     <div>
//                       <h3 className="text-xl font-black text-white italic tracking-tighter">{signal.module}</h3>
//                       <div className="flex items-center gap-2 text-[10px] font-bold text-muted-foreground uppercase">
//                         <Clock size={12} /> {getTimeAgo(signal.created_at)}
//                       </div>
//                     </div>
...
//                       initial={{ width: 0 }}
//                       animate={{ width: `${signal.confidence_score}%` }}
//                       className={`h-full rounded-full ${signal.confidence_score > 85 ? 'bg-neon-green' : 'bg-primary'}`}
//                     />
//                   </div>
//                 </div>
//               </motion.div>
...
// Format Date and Time: e.g., "Mar 4, 10:16 PM"
    ...
    <div className="min-h-screen p-4 md:p-8 space-y-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tighter italic text-white uppercase">AI Signals</h1>
            <p className="text-xs font-bold text-muted-foreground tracking-[0.3em] uppercase italic">Live Prediction Engine</p>
          </div>
        </div>
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  <div className="w-full bg-white/5 rounded-full h-2 overflow-hidden">
                    <motion.div 
                      initial={{ width: 0 }}
                      animate={{ width: `${signal.confidence_score}%` }}
                      className={`h-full rounded-full ${signal.confidence_score > 85 ? 'bg-neon-green shadow-[0_0_10px_rgba(0,255,136,0.3)]' : 'bg-primary shadow-[0_0_10px_rgba(var(--primary),0.3)]'}`}
                    />
                  </div>
                </div>
              </motion.div>
